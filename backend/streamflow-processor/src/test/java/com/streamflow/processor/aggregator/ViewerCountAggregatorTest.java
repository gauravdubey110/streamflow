...
/**
 * Unit tests for {@link ViewerCountAggregator} backed by a real Redis instance
 * in Testcontainers.
 *
 ...
 * <p>Covers:
 * <ul>
 *   <li>AC1 — 1000 JOINs → ZCARD == 1000</li>
 *   <li>AC2 — 1000 JOINs + 200 DROPs → ZCARD == 800</li>
 *   <li>AC3 — same JOIN 5 × → ZCARD == 1 (idempotency)</li>
 *   <li>Eviction — stale entries removed by {@link ViewerCountAggregator#evictStaleEntries}</li>
 * </ul>
 */
@Testcontainers
class ViewerCountAggregatorTest {
    ...
    void knownStreamIds_tracksStreamsOnJoinAndDrop() {
        ...
        assertThat(aggregator.getKnownStreamIds())
