 ...
 *
 * <p>SPEC-17: verifies the static helper methods that format the date/hour
 * bucket strings used as partition keys in Cassandra tables.
 *
...
class BucketHelperTest {
    ...
    void dayBucket_formats_yyyyMMdd() {
        ...
        assertThat(CassandraAlertRepository.dayBucket(ts.toEpochMilli()))
                .isEqualTo("2024-06-03");
    }
