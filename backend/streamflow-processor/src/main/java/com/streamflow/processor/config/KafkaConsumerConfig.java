 ...
 * <p>SPEC-17 additions:
 * <ul>
 *   <li>Adds {@link #alertConsumerFactory()} and {@link #alertListenerContainerFactory()}
 *       for the {@code alerts} topic. The {@link com.streamflow.processor.consumer.AlertCassandraConsumer}
 *       uses group {@code alert-cassandra-group} to persist alerts to Cassandra independently
 *       of the API gateway consumer group.</li>
 * </ul>
 *
...
public class KafkaConsumerConfig {
     ...
     *
     * <p>Uses group {@code alert-cassandra-group} so this consumer is independent of
     * the API gateway's {@code api-gateway-group} consumer on the same topic.
     */
    @Bean
    ...
    /**
     * Container factory for the {@code alerts} listener in
     * {@link com.streamflow.processor.consumer.AlertCassandraConsumer}.
     *
     * <p>Concurrency = 1: alert throughput is low (a few per minute per stream).
     * Manual ack ensures Cassandra dispatch is recorded before offset is committed.
     *
