 ...
 * <ol>
 *   <li>Start at 100.
 *   <li>Subtract {@code bufferRatePct × 5}, capped at −40. A 0 % buffer rate removes nothing; an 8
 *       % rate removes 40 points.
 *   <li>Subtract {@code frameDropRate × 1 000}, capped at −30. A 0.03 frame-drop rate removes 30
 *       points (cap).
 *   <li>Subtract {@code max(0, encoderLatencyMs − 150) / 10}, capped at −20. Latencies below 150 ms
 *       are free; 350 ms removes 20 points (cap).
 *   <li>Subtract {@code max(0, 3 000 − bitrateKbps) / 100}, capped at −10. Bitrates ≥ 3 000 kbps
 *       are free; 2 000 kbps removes 10 points (cap).
 *   <li>Floor result at 0; round to one decimal place.
 * </ol>
 *
 * <p>This class is intentionally kept pure (no Spring dependencies beyond {@code @Component}) and
 * is heavily unit-tested in {@code HealthScoreCalculatorTest}.
 */
@Component
public class HealthScoreCalculator {
  ...
  public double compute(
      double bufferRatePct, double frameDropRate, int encoderLatencyMs, int bitrateKbps) {
