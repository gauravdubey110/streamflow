 ...
 *
 * <p>Partition key: {@code (stream_id, date_bucket)} — daily buckets keep individual partitions
 * bounded (Plan §8). Clustering columns: {@code timestamp DESC, alert_id ASC} for latest-first
 * reads.
 *
...
public class AlertEntity {
  ...
  /**
   * Partition column 2: daily bucket derived from {@code timestamp}. Format: {@code yyyy-MM-dd}
   * (e.g. {@code "2024-06-03"}).
   */
