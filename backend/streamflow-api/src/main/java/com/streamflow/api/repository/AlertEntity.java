 ...
 *
 * <p>SPEC-18 R6: mirrors the write-side entity in {@code streamflow-processor} but lives in
 * the api module so the api gateway does not depend on the processor module's internal classes.
 *
 * <p>Primary key: {@code (stream_id, date_bucket)} partitioned;
 * {@code timestamp DESC, alert_id ASC} clustered.
 */
@Data
@Builder
@NoArgsConstructor
