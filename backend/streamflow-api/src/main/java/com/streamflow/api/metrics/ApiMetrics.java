 ...
 *
 * <ul>
 *   <li>tag {@code topic=metrics-aggregated} — incremented by {@link
 *       com.streamflow.api.websocket.MetricsPushConsumer}
 *   <li>tag {@code topic=alerts} — incremented by {@link
 *       com.streamflow.api.websocket.AlertPushConsumer}
 * </ul>
 *
 * <p>SPEC-20 NFR2 — Cardinality is bounded: the {@code topic} tag has a fixed set of values (2
 * topics) so series cardinality is well within the 5 000-series limit.
 */
@Component
public class ApiMetrics {
  ...
  /**
   * Increments the {@code metrics-aggregated} consumed counter. Called from {@link
   * com.streamflow.api.websocket.MetricsPushConsumer}.
   */
  ...
  /**
   * Increments the {@code alerts} consumed counter. Called from {@link
   * com.streamflow.api.websocket.AlertPushConsumer}.
   */
