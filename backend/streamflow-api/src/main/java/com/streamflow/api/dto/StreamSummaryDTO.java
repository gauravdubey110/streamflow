 ...
 *
 * <p>SPEC-06 §4: Built from the {@code stream_snapshot:{streamId}} Redis JSON. {@code streamName}
 * is stubbed to {@code streamId} until stream-metadata persistence is introduced in a later spec.
 *
 ...
 * @param circuitBreakerState Resilience4j CB state: {@code CLOSED}, {@code OPEN}, or {@code
 *     HALF_OPEN}
 */
