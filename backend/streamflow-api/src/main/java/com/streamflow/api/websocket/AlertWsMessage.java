 ...
 *
 * <p>Broadcast to {@code /topic/streams/{streamId}/alerts} whenever a new {@link
 * com.streamflow.common.dto.AlertEventDTO} is consumed from the {@code alerts} Kafka topic.
 *
