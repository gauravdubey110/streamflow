 ...
 *
 * <p>SPEC-13 R4: posted to {@code POST /api/v1/streams/{streamId}/chaos}. The {@code scenario}
 * field is validated as a non-null {@link ChaosScenarioDTO} enum value.
 *
...
public record ChaosRequest(
    @NotNull(message = "scenario must not be null") ChaosScenarioDTO scenario,
