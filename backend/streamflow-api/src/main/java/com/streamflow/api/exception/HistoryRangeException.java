...
/**
 * Thrown when a history query's time range exceeds the configured maximum
 * (default 24 hours, controlled by {@code streamflow.history.max-range-hours}).
 *
 * <p>SPEC-18 R3: mapped to HTTP 400 with a problem-details JSON body by
 * {@link GlobalExceptionHandler#handleHistoryRange(HistoryRangeException)}.
 */
