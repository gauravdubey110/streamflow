...
class ChaosControllerTest {
  ...
  @MockBean private ProducerChaosClient producerChaosClient;
  ...
  void postChaos_validRequest_returns202WithChaosId() throws Exception {
    ...
    mockMvc
        .perform(
            post("/api/v1/streams/stream-001/chaos")
  ...
  void deleteChaos_existingId_returns204() throws Exception {
    ...
    mockMvc
        .perform(delete("/api/v1/streams/stream-001/chaos/chaos-123"))
  ...
  void deleteChaos_unknownId_returns404() throws Exception {
    ...
    mockMvc
        .perform(delete("/api/v1/streams/stream-001/chaos/unknown"))
