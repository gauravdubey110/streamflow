 ...
 *
 * <ol>
 *   <li>The correct STOMP destination is used ({@code /topic/streams/{streamId}/alerts}).
 *   <li>The {@link AlertWsMessage} envelope has {@code type = "ALERT_FIRED"}.
 *   <li>All payload fields are correctly mapped from {@link AlertEventDTO}.
 * </ol>
 */
...
class AlertPushConsumerTest {
  ...
  @InjectMocks private AlertPushConsumer consumer;
  ...
  void consume_broadcastsToCorrectDestination() {
    ...
    verify(messagingTemplate)
        .convertAndSend(eq("/topic/streams/stream-001/alerts"), payloadCaptor.capture());
