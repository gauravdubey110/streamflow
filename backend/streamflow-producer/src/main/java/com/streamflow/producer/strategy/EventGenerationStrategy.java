 ...
 *
 * <p>SPEC-03 Design Notes: extensibility hook for later specs (e.g. SPEC-13 chaos injection
 * will add {@code SpikeLoadStrategy}).  {@code NormalLoadStrategy} is the only implementation
 * for this spec.
 */
