 ...
 * </ul>
 *
 * <p>Quality distribution is uniformly drawn from all five tiers for simplicity at this stage; the
 * quality-distribution aggregator in SPEC-10 will track the real distribution.
 *
 * <p>Region is drawn from a weighted set reflecting a realistic IN/US mix.
 *
 * <p>SPEC-10 R1: BUFFER_START events carry a random {@code bufferDurationMs} in the range [500,
 * 3000] ms to simulate realistic buffering durations.
 */
@Component
