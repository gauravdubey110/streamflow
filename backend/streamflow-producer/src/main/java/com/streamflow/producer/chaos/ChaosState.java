 ...
 *
 * <p>SPEC-13 Design Notes: tracked in {@code ConcurrentHashMap<chaosId, ChaosState>} inside {@link
 * ChaosInjector}; the {@link #autoRevertFuture} is used to cancel the scheduler on early
 * cancellation via {@link ChaosInjector#cancel(String)}.
 *
