...
public enum VideoQuality {
  ...
  /**
   * Returns the JSON wire string (e.g. {@code "720p"}). Jackson calls this during serialization
   * because of {@code @JsonValue}.
   */
  @JsonValue
  ...
  /**
   * Factory used by Jackson during deserialization and by application code that receives raw
   * quality strings from Kafka messages.
   *
