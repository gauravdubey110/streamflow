 ...
 *
 * <p>{@code qualityDistribution} maps quality tier strings (e.g. {@code "1080p"}) to their
 * percentage of current viewers (e.g. {@code 45.2}).
 *
 * <p>{@code circuitBreakerState} carries the Resilience4j CB state as a string ({@code "CLOSED"},
 * {@code "OPEN"}, or {@code "HALF_OPEN"}).
 */
